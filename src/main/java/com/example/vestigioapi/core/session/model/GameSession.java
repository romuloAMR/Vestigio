...
public class GameSession extends Auditable {
    ...
    private List<com.example.vestigioapi.core.session.model.Move> moves = new ArrayList<>();
    ...
    public List<com.example.vestigioapi.core.session.model.Move> getMoves() {
        return moves;
    }

    public void setMoves(List<com.example.vestigioapi.core.session.model.Move> moves) {
        this.moves = moves;
    }
}
